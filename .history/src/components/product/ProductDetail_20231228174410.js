			...
			<div class="col-lg-8">
                ...
                {product ? (
                    <div>
                        ...
                        <li><i class="icofont-check mr-2"></i>S{product.tabletP.dies}</li>
                        ...
                        <li><i class="icofont-check mr-2"></i>
                        {product.tabletP.maxDepthOfFill}</li>
                        <li><i class="icofont-check mr-2"></i> {product.tabletP.productionCapacity}</li>
                    </div>
                ) : (
                    <div>
                        <li><i class="icofont-check mr-2"></i>{product.liquidP.modelairPressureNumber}</li>
                        <li><i class="icofont-check mr-2"></i>S{product.liquidP.airVolume}</li>
