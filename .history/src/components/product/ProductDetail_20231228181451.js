...
<section class="section department-single">
  ...
  <div>
    <li><i class="icofont-check mr-2"></i>{product && product.liquidP && product.liquidP.liquidP}</li>
    <li><i class="icofont-check mr-2"></i>{product && product.liquidP && product.liquidP.airVolume}</li>
    <li><i class="icofont-check mr-2"></i>{product && product.liquidP && product.liquidP.fillingSpeed}</li>
    <li><i class="icofont-check mr-2"></i>{product && product.liquidP && product.liquidP.fillingRange}</li>
  </div>
)}
					</ul>
