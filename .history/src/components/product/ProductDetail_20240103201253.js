...
const ProductDetail = () => {
    const { id } = useParams();
    const [product, setProduct] = useState({ tabletP: {}}, { liquidP: {}}, {Capsule/Encapsulation: {}},);
                                ...
                                <ul class="list-unstyled department-service">
                                    {product && product.tabletP ? (
                                        ...
                                        <li>
                                            <i class="icofont-check mr-2"></i>
                                            {
                                                product.Capsule/Encapsulation.liquidP}
                                        </li>
                                        <li>
                                            <i class="icofont-check mr-2"></i>
                                            {
                                                product.Capsule/Encapsulation.airVolume}
                                        </li>
                                        <li>
                                            <i class="icofont-check mr-2"></i>
                                            {
                                                product.Capsule/Encapsulation
                                                    .fillingSpeed}
                                        </li>
                                        <li>
                                            <i class="icofont-check mr-2"></i>
