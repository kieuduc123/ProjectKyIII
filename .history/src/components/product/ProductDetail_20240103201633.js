...
const ProductDetail = () => {
    const { id } = useParams();
    const [product, setProduct] = useState({ tabletP: {}}, { liquidP: {}}, {Capsule: {} });
    ...
    <>
      ...
      <li>
        <i className="icofont-check mr-2"></i>
        {product.tabletP.maxDiameterOfTablet}
      </li>
      <li>
        <i className="icofont-check mr-2"></i>
      ...
      <li>
        <i className="icofont-check mr-2"></i>
        {product.tabletP.productionCapacity}
      </li>
    </>
    ...
    <>
      <li>
        <i className="icofont-check mr-2"></i>
        {product.Capsule.liquidP}
      </li>
      <li>
        <i className="icofont-check mr-2"></i>
        {product.Capsule.airVolume}
      </li>
      <li>
        <i className="icofont-check mr-2"></i>
