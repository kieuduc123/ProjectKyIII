                        ...
                        <div class="col-lg-8">
                            <div class="department-content mt-5">
                                ...
                                <ul class="list-unstyled department-service">
                                    ...
                                    ) :product && product.cateGet.cateName === "Capsule/Encapsulation" ? (
                                        <>
                                          <li>
                                            <i className="icofont-check mr-2"></i>
                                            {product['Capsule/Encapsulation'].capsuleP && product['Capsule/Encapsulation'].capsuleP.capsuleSize}
                                          </li>
                                          <li>
                                            <i className="icofont-check mr-2"></i>
                                            {product['Capsule/Encapsulation'].capsuleP && product['Capsule/Encapsulation'].capsuleP.machineDimension}
                                          </li>
                                          <li>
                                            <i className="icofont-check mr-2"></i>
                                            {product['Capsule/Encapsulation'].capsuleP && product['Capsule/Encapsulation'].capsuleP.fillingSpeed}
                                          </li>
                                          <li>
                                            <i className="icofont-check mr-2"></i>
                                            {product['Capsule/Encapsulation'].fillingRange}
                                          </li>
                                        </>
                                      ) : null}
                                </ul>
