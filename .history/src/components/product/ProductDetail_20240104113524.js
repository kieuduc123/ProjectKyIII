...
const ProductDetail = () => {
  ...
  <div class="container">
    <div class="row gx-5">
      ...
      maxHeight: "100vh",
      margin: "auto"
    }} class="rounded-4 fit" src="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/items/detail1/big.webp" />
          </a>
        </div>
        ...
        <div class="px-0 border rounded-2 shadow-0">
          <div class="card">
            <div class="card-body">
              ...
              <div class="d-flex mb-3">
                <a href="#" class="me-3">
                  <img src="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/items/10.webp" s class="img-md img-thumbnail" />
                </a>
                <div class="info">
