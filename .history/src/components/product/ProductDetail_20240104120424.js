                            ...
                            <div class="department-content mt-5">
                                ...
                                <ul class="list-unstyled department-service">
                                    {product && product.tabletP ? (
                                        ...
                                        <>
                                          <p>Category: {product['Capsule/Encapsulation'].cateName}</p>
                                          <li>
                                            <i className="icofont-check mr-2"></i>
                                            {product['Capsule/Encapsulation'].capsuleP.capsuleSize}
                                          </li>
                                          {/* Các thông tin khác về Capsule/Encapsulation */}
                                        </>
                                      ) : null}
                                </ul>
          ...
          <div class="tab-content" id="ex1-content">
            <div class="tab-pane fade show active" id="ex1-pills-1" role="tabpanel" aria-labelledby="ex1-tab-1">
              ...
              <table class="table border mt-3 mb-2">
                ...
                <tr>
                  <th class="py-2">Graphics</th>
                  <td class="py-2">  { product.tabletP.productionCapacity
                                                }</td>
                </tr>
              </table>
            </div>
            ...
            <div class="tab-content" id="ex1-content">
              <div class="tab-pane fade show active" id="ex1-pills-1" role="tabpanel" aria-labelledby="ex1-tab-1">
                ...
                <table class="table border mt-3 mb-2">
                  <tr>
                    <th class="py-2">Display:</th>
                    <td class="py-2">   {product.liquidP.liquidP}</td>
                  </tr>
                  <tr>
                    <th class="py-2">Processor capacity:</th>
