              ...
              <div class="border rounded-2 px-3 py-2 bg-white">
                ...
                <div class="" id="ex1-content">
                  <div class="tab-pane fade show active" id="ex1-pills-1" role="tabpanel" aria-labelledby="ex1-tab-1">
                    ...
                    <table class="table border mt-3 mb-2">
                      <tr>
                        <th class="w-50 py-2">Air Pressure:</th>
                        <td class="py-2">   {product.liquidP.airPressure}</td>
                      </tr>
                      <tr>
                        <th class="w-50 py-2">Air Volume:</th>
                        <td class="py-2">{product.liquidP.airVolume}</td>
                      </tr>
                      <tr>
                        <th class="w-50 py-2">Filling Speed</th>
                        <td class="py-2">  {product.liquidP.fillingSpeed}</td>
                      </tr>
                      <tr>
                        <th class="w-50 py-2">FillingRange</th>
                ...
                <div class="border rounded-2 px-3 py-2 bg-white">
                  ...
                  <div class="" id="ex1-content">
                    <div class="tab-pane fade show active" id="ex1-pills-1" role="tabpanel" aria-labelledby="ex1-tab-1">
                      ...
                      <table class="table border mt-3 mb-2">
            <tr>
              <th class="w-50 py-2">Capsule Size:</th>
              <td class="py-2">{product.capsuleP.capsuleSize}</td>
            </tr>
            <tr>
              <th class="w-50 py-2">Machine Dimension:</th>
              <td class="py-2">{product.capsuleP.machineDimension}</td>
            </tr>
            <tr>
              <th class="w-50 py-2">Output:</th>
              <td class="py-2">{product.capsuleP.output}</td>
            </tr>
            <tr>
              <th class="w-50 py-2">Shipping Weight:</th>
