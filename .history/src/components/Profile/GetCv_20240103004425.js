...
const handleSubmitCv = async() => {
    const res = await axios.post(`https://pharmacyonline.azurewebsites.net/api/Profile/candidate/submit?idCandidate=${fileCV.candidateId
}&idProfileDetail=${fileCV.id}`,
    { headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${accessToken}`,
      },
            ...
            <table class="table table-striped table-hover table-bordered">
               ...
               return (
                ...
                <tr>
                    ...
                    <td>{i.number}</td>
                    <td>
                        <a href="#" class="edit" title="Edit" data-toggle="tooltip"><i class="fa-solid fa-check"></i></a>
