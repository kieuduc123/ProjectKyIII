...
const handleSubmitCv = async () => {
    try{
        const res = await axios.post("https://pharmacyonline.azurewebsites.net/api/Profile/candidate/submit?idCandidate=20&idProfileDetail=KCFJC4",
        // ${fileCV.candidateId}&idProfileDetail=${fileCV.id}`,
        {
            headers: {
               "Content-Type": "application/json",
               Authorization: `Bearer ${accessToken}`,
            ...
            <table class="table table-striped table-hover table-bordered">
               ...
               return (
                ...
                <tr>
                    ...
                    <td>{i.number}</td>
                    <td>
                        <button  class="edit" title="Edit" onClick={handleSubmitCv} ><i class="fa-solid fa-check"></i></button>
