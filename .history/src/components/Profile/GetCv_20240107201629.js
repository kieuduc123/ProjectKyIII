          ...
          <div class="col-12 col-lg-auto mb-3" style={{width: "200px"}}>
            <div class="card p-3">
              <div class="e-navlist e-navlist--active-bg">
                <ul class="nav">
                  <li class="nav-item text-black"><a class="nav-link px-2 " href="#"><i class="fa fa-fw fa-bar-chart mr-1"></i><span>Status</span></a></li>
                  <li class="nav-item pl-2"><a class="nav-link px-2" href="https://www.bootdey.com/snippets/view/bs4-crud-users" target="__blank"><i class="fa fa-fw fa-th mr-1"></i><span>EDIT</span></a></li>
                  <li class="nav-item" pl-2><a class="nav-link px-2" href="https://www.bootdey.com/snippets/view/bs4-edit-profile-page" target="__blank"><i class="fa fa-fw fa-cog mr-1"></i><span>SUBMITTED</span></a></li>
                </ul>
              </div>
            </div>
          </div>
                        ...
                        <table class="table table-bordered">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="text-center align-middle">hwerjvnf</td>
