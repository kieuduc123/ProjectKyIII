            ...
            <div class="card p-3">
              <div class="e-navlist e-navlist--active-bg">
                <ul class="nav">
                  ...
                  <li class="nav-item pl-2"><a class="nav-link px-2" href="https://www.bootdey.com/snippets/view/bs4-edit-profile-page" target="__blank"><i class="fa fa-fw fa-cog mr-1"></i><span>Subitted</span></a></li>
                </ul>
              </div>
            </div>
          </div>
