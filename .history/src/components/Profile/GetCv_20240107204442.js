              ...
              <div class="e-navlist e-navlist--active-bg">
                <ul class="nav">
                  ...
                  <li class="nav-item pl-3">
                    <button  class="nav-link px-2" onClick={() => getProfile('EDIT')}>
                       <span  >Edit</span></button></li>
                  <li class="nav-item pl-2">
                    <button class="nav-link px-3" type="submit"  onClick={() => handleOrderDetail(data.id)    } ><span>Submitted</span></button></li>
                </ul>
              </div>
            </div>
          </div>
