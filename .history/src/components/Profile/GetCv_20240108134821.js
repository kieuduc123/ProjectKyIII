                          ...
                          {data.length >= 0  &&
                            ...
                            <tr>
                              <td class="text-nowrap align-middle">{data.id}</td>
                                            ...
                                            <button className="bg-primary  btn-outline-secondary badge"  data-toggle="modal" data-target="#user-form-modal" type="submit" onClick={() => getProfileDetails(data.id) }>Details</button>
                                              </td> 
