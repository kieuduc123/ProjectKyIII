        ...
        <section className="mt-0 overflow-hidden  vh-100 d-flex justify-content-center align-items-center p-4">
            ...
            <div className="col col-md-8 col-lg-6 col-xxl-5">
                ...
                <div className="shadow-xl p-4 p-lg-5 bg-white">
                    ...
                    <GoogleOAuthProvider className="btn btn-twitter d-block mb-2" clientId="683845897017-3a3kb6vqd60kbf48s78m7gb0d6a3cglg.apps.googleusercontent.com">
                        <GoogleLogin
                            onSuccess={(credentialResponse) => {
                              ...
                              localStorage.setItem(
                                "google",
                                JSON.stringify(credentialResponse.credential.name)
                            );
                              navigate("/")
                            }}
                            onError={() => {
                    ...
                    <NavLink to="#" className="btn btn-twitter d-block mb-2">
                        <i className="ri-twitter-fill align-bottom"></i> Login
                        with Twitter
                    </NavLink>
