      ...
      onSuccess: async credentialResponse => {
        try{
            ...
            //sử dụng fetch send data to BE:
             const backendResponse = await fetch('https://localhost:7224/api/Candidate/authen/google', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
                body: JSON.stringify({ token: credentialResponse.accessToken }),
            })
        ...
        <section className="mt-0 overflow-hidden  vh-100 d-flex justify-content-center align-items-center p-4">
            ...
            <div className="col col-md-8 col-lg-6 col-xxl-5">
                ...
                <div className="shadow-xl p-4 p-lg-5 bg-white">
                    ...
                    <NavLink to="#" className="btn btn-facebook d-block mb-2" onClick={login}>
