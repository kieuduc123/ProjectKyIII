            ...
            <div className="row d-flex align-items-center py-5">
                <div className="col-lg-6 text-start">
                    ...
                    <p className="light-300">
                        Vector illustration credit goes to <NavLink rel="nofollow" to="http://freepik.com/" target="_blank">FreePik</NavLink> website. Purple Buzz is provided by TemplateMo. Lorem ipsum dolor sit amet, consectetur.
                    </p>
                </div>
