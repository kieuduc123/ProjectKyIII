...
Năm 2008, Công ty Cổ phần Dược phẩm Boston Việt Nam (gọi tắt là BOSTON PHARMA) chính thức đổi tên theo sự liên doanh và nhượng quyền từ Boston Hoa Kỳ.<NavLink rel="nofollow" to="http://freepik.com/" target="_blank">FreePik</NavLink> website. Purple Buzz is provided by TemplateMo. Lorem ipsum dolor sit amet, consectetur.
                    </p>
                </div>
    ...
    <section className="container py-5">
        <div className="pt-5 pb-3 d-lg-flex align-items-center gx-5">
            ...
            <div className="col-lg-3">
                ...
                <h2 className="h2 py-5 typo-space-line">Các Tiến Sĩ</h2>
            ...
            <div className="col-lg-9 row">
                <div className="team-member col-md-4">
                    ...
                    <img className="team-member-img img-fluid rounded-circle p-4" src="./assets/img/tacgia1.jpg" alt=""/>
                ...
                <div className="team-member col-md-4">
                    {/* <img className="team-member-img img-fluid rounded-circle p-4" src="./assets/img/team-02.jpg" alt=""/> */}
                    <img className="team-member-img img-fluid rounded-circle p-4" src="./assets/img/tacgia2.jpg" alt=""/>
                    <ul className="team-member-caption list-unstyled text-center pt-4 text-muted light-300">
                        <li>VĂN TIẾN </li>
                ...
                <div className="team-member col-md-4">
                    {/* <img className="team-member-img img-fluid rounded-circle p-4" src="./assets/img/team-03.jpg" alt=""/> */}
                    <img className="team-member-img img-fluid rounded-circle p-4" src="./assets/img/tacgia3.png" alt=""/>
                    <ul className="team-member-caption list-unstyled text-center pt-4 text-muted light-300">
                        <li>QUANG HUY</li>
                        <li>Developer</li>
                    </ul>
