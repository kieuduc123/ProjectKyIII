        ...
        <div className="pt-5 pb-3 d-lg-flex align-items-center gx-5">
            ...
            <div className="col-lg-9 row">
                <div className="team-member col-md-4">
                    ...
                    <img className="https://bostonpharma.com.vn/vnt_upload/about/Chu_Khoa_2023___Web.png" alt=""/>
                    <ul className="team-member-caption list-unstyled text-center pt-4 text-muted light-300">
                        <li>MR. LƯƠNG ĐĂNG KHOA
</li>
                        <li>TỔNG GIÁM ĐỐC</li>
                    </ul>
                </div>
                <div className="team-member col-md-4">
                    ...
                    <img className="https://bostonpharma.com.vn/vnt_upload/about/Chi_Lieu_2023___web.jpg" alt=""/>
                    <ul className="team-member-caption list-unstyled text-center pt-4 text-muted light-300">
                        <li>MS. TRỊNH THỊ THÚY LIỄU</li>
                        <li>Giám Đốc Tài Chính</li>
                    </ul>
                </div>
                <div className="team-member col-md-4">
                    {/* <img className="team-member-img img-fluid rounded-circle p-4" src="./assets/img/team-03.jpg" alt=""/> */}
                    <img className="https://bostonpharma.com.vn/vnt_upload/about/anh_Trinh_2023___web.jpg" alt=""/>
                    <ul className="team-member-caption list-unstyled text-center pt-4 text-muted light-300">
