            ...
            <div className="row text-center">
                <div className="col-md-3 mb-3">
                    <div className="card partner-wap py-5">
                        <NavLink to="#"><img className='display-1 text-white bx bxs-buildings' src="https://bostonpharma.com.vn/vnt_upload/File/11_2019/logo-EU-GMP-11.jpg" alt=''></img></NavLink>
                    </div>
                </div>
                <div className="col-md-3 mb-3">
                    <div className="card partner-wap py-5">
                        <NavLink to="#"><img className='display-1 bx text-white bxs-check-shield bx-lg' src="https://bostonpharma.com.vn/vnt_upload/File/11_2019/Logo-GMP-WHO.jpg" alt=''></img></NavLink>
                    </div>
                </div>
                <div className="col-md-3 mb-3">
                    <div className="card partner-wap py-5">
                        <NavLink to="#"><img  className='display-1 text-white bx bxs-bolt-circle w-full' src='https://bostonpharma.com.vn/vnt_upload/File/11_2019/gmp.jpg' alt=''></img></NavLink>
                    </div>
                </div>
                <div className="col-md-3 mb-3">
                    <div className="card partner-wap py-5">
                        <NavLink to="#"><img className='display-1 text-white bx bxs-spa' src='https://bostonpharma.com.vn/vnt_upload/File/11_2019/CE.jpg' alt=''></img></NavLink>
                    </div>
                </div>
            </div>
        </div>
