            ...
            <div className="row text-center">
                <div className="col-md-3 mb-3">
                    <div className="card partner-wap py-5">
                        <NavLink to="#"><img className='display-1 text-white bx bxs-buildings w-100' src="https://bostonpharma.com.vn/vnt_upload/File/11_2019/logo-EU-GMP-11.jpg" alt=''></img></NavLink>
                    </div>
                </div>
                <div className="col-md-3 mb-3">
                    <div className="card partner-wap py-5">
