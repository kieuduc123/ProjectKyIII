    ...
    <section className="bg-secondary py-3">
        <div className="container py-5">
            ...
            <div className="row text-center">
                ...
                <div className="col-md-3 mb-3">
                    <div className=" py-5">
                        <NavLink to="#"><img className='display-1 bx text-white bxs-check-shield bx-lg w-100' src="https://bostonpharma.com.vn/vnt_upload/File/11_2019/Logo-GMP-WHO.jpg" alt=''></img></NavLink>
                    </div>
                </div>
                <div className="col-md-3 mb-3">
                    <div className=" py-5">
                        <NavLink to="#"><img  className='display-1 text-white bx bxs-bolt-circle w-100' src='https://bostonpharma.com.vn/vnt_upload/File/11_2019/gmp.jpg' alt=''></img></NavLink>
                    </div>
                </div>
                <div className="col-md-3 mb-3">
                    <div className=" py-5">
                        <NavLink to="#"><img className='display-1 text-white bx bxs-spa w-100' src='https://bostonpharma.com.vn/vnt_upload/File/11_2019/CE.jpg' alt=''></img></NavLink>
                    </div>
                </div>
            </div>
        </div>
