...
Năm 2008, Công ty Cổ phần Dược phẩm Boston Việt Nam (gọi tắt là PHARMACEUTICALS) chính thức đổi tên theo sự liên doanh và nhượng quyền từ Boston Hoa Kỳ.
    ...
    <section className="container py-5">
        <div className="pt-5 pb-3 d-lg-flex align-items-center gx-5">
            ...
            <div className="col-lg-3">
                ...
                Nghiên cứu và cải tiến vì sức khỏe cộng đồng Trong những năm qua,PHARMACEUTICALS – một trong những công ty Dược phẩm hàng đầu Việt Nam, đã và đang nỗ lực nghiên cứu không ngừng để cải tiến chất lượng thuốc vì sức khỏe cộng đồng.
                </p>
            </div>
    ...
    <section className="bg-secondary py-3">
        <div className="container py-5">
            <h2 className="h2 text-white text-center py-5">TIÊU CHUẨN</h2>
            <p className='text-white text-center '>PHARMACEUTICALS chuyên sản xuất và phân phối Dược phẩm, Thực phẩm Bảo vệ sức khỏe ưu tiên chất lượng hàng đầu thông qua việc đảm bảo nghiêm ngặt các Tiêu chí:</p>
            <div className="row text-center">
                <div className="col-md-3 mb-3">
                    <div className=" py-5">
                        <NavLink to="#"><img className= ' cart display-1 text-white bx bxs-buildings w-100' src="https://bostonpharma.com.vn/vnt_upload/File/11_2019/logo-EU-GMP-11.jpg" alt=''></img></NavLink>
                    </div>
                </div>
                <div className="col-md-3 mb-3">
                    <div className=" py-5">
                        <NavLink to="#"><img className=' cart display-1 bx text-white bxs-check-shield bx-lg w-100' src="https://bostonpharma.com.vn/vnt_upload/File/11_2019/Logo-GMP-WHO.jpg" alt=''></img></NavLink>
                    </div>
                </div>
                <div className="col-md-3 mb-3">
                    <div className=" py-5">
                        <NavLink to="#"><img  className=' cart display-1 text-white bx bxs-bolt-circle w-100' src='https://bostonpharma.com.vn/vnt_upload/File/11_2019/gmp.jpg' alt=''></img></NavLink>
                    </div>
                </div>
                <div className="col-md-3 mb-3">
                    <div className=" py-5">
                        <NavLink to="#"><img className=' cart display-1 text-white bx bxs-spa w-100' src='https://bostonpharma.com.vn/vnt_upload/File/11_2019/CE.jpg' alt=''></img></NavLink>
                    </div>
                </div>
            </div>
        </div>
