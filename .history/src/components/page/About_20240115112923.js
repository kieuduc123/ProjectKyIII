        ...
        <div class="container">
            <div class="row align-items-end">
                <div class="col-12 col-lg-6">
                    ...
                    <p>Pharmacy Company was established in the year 19XX by John Smith, a skilled pharmacist. Mr. Smith had a vision of providing high-quality pharmaceutical products and excellent healthcare services to the community. </p>

                    <NavLink class="d-inline-block bg-primary text-white rounded p-2" to="/aboutshistory">Read More</NavLink>
                </div>
