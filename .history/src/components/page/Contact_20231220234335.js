        ...
        <div className="container py-4">
            <div className="row align-items-center justify-content-between">
                <div className="contact-header col-lg-4">
                    <h1 className="h2 pb-3 text-primary">Liên Hệ</h1>
                    {/* <h3 className="h4 regular-400">Elit, sed do eiusmod tempor</h3> */}
                    <p className="light-300">
                    Xin kính chào quý khách! Cảm ơn quý khách đã quan tâm đến  <strong className='text-primary '>PHARMAC EUTICALS  .</strong>
