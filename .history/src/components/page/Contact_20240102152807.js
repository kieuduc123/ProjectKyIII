        ...
        <form id="contact-form" class="contact__form " method="post" action="mail.php">
          ...
          <div class="col-lg-6 d-none">
              <div class="form-group">
                <input name="idCandidate" id="idCandidate" type="text" class="form-control" placeholder="Your Full Name"/>
            ...
            <Label htmlFor="address">Phone</Label>
              <div class="form-group">
                <input name="number" id="number" type="text" class="form-control" placeholder="Your Phone" required/>
              </div>
            </div>
            <div class="col-lg-6">
