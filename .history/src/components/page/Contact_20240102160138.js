...
const Contact = () => {
  ...
  const handleFormCv = async (e) => {
    ...
    const res = await sendFormCv(user.id ,formCv, {
      headers: {
          ...
          <div class="col-lg-6">
            ...
            <Label htmlFor="address">Address</Label>
              <div class="form-group">
                ...
                type="address" class="form-control" placeholder="Your address Address" required/>
              </div>
            </div>
            ...
            <Label htmlFor="address">Phone</Label>
              <div class="form-group">
                ...
                type="number" class="form-control" placeholder="Your Phone" required/>
              </div>
            </div>
            <div class="col-lg-6">
            <Label htmlFor="email">Email</Label>
              <div class="form-group">
                <input name="email" id="phone" 
                  ...
                  type="email" class="form-control" placeholder="Your Phone Email" required/>
              </div>
            </div>
            ...
            <Label htmlFor="thumbnail">Thumbnail</Label>
              <div class="form-group">
                ...
                id="thumbnail" type="file" class="form-control" placeholder="Your Thumbnail" required/>
              </div>
            </div>
            <div class="col-lg-6">
            <Label htmlFor="fileCv">File Cv</Label>
              <div class="form-group">
                ...
                type="file" class="form-control" placeholder="Your  CV" required/>
              </div>
            </div>
            ...
            <Label htmlFor="skills">Skills</Label>
              <div class="form-group">
                <input name="skills" id="skills" 
                  ...
                  type="text" class="form-control" placeholder="Your skills" required/>
              </div>
            </div>
            <div class="col-lg-6">
            <Label htmlFor="universityOrCollege">UniversityOrCollege</Label>
              ...
              <div class="form-group">
                <input name="universityOrCollege"
                 ...
                 id="universityOrCollege" type="text" class="form-control" placeholder="Your universityOrCollege" required/>
              </div>
            </div>
            <div class="col-lg-6">
            <Label htmlFor="issuedDate">IssuedDate</Label>
              ...
              <div class="form-group">
                <input name="issuedDate"
                 ...
                 id="issuedDate" type="datetime-local" class="form-control" placeholder="Your issuedDate" required/>
              </div>
            </div>
            <div class="col-lg-6">
            <Label htmlFor="expiryDate">ExpiryDate</Label>
              <div class="form-group">
                <input name="expiryDate"
                 ...
                 id="expiryDate" type="datetime-local" class="form-control" placeholder="Your expiryDate" required/>
              </div>
            </div>
            <div class="col-lg-6">
            <Label htmlFor="major">Major</Label>
              <div class="form-group">
                <input name="major" id="major"
                 ...
                 type="major" class="form-control" placeholder="Your Major" required/>
              </div>
            </div>
            <div class="col-lg-6">
            <Label htmlFor="scientificAchievements">ScientificAchievements</Label>
              ...
              <div class="form-group">
                ...
                id="scientificAchievements" type="text" class="form-control" placeholder="Your scientificAchievements" required/>
              </div>
            </div>
            <div class="col-lg-6">
            <Label htmlFor="workExperiences">WorkExperiences</Label>
              ...
              <div class="form-group">
                ...
                id="workExperiences" type="text" class="form-control" placeholder="Your workExperiences" required/>
              </div>
            </div>
            <div class="col-lg-6">
            <Label htmlFor="reference">Reference</Label>
              ...
              <div class="form-group">
                ...
                id="reference" type="text" class="form-control" placeholder="Your reference" required/>
              </div>
            </div>
          </div>
          <div>
