...
<div class="container rounded bg-white mt-5 mb-5">
    <div class="row border">
        <div class="col-md-3 border-right">
          ...
          style={{"width" : "150px"}}  src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg" alt=''/>
              <span class="font-weight-bold">Edogaru</span><span class="text-black-50">edogaru@mail.com.my</span></div>
        </div>
            ...
            <div class="p-3 py-5">
                ...
                type="text" class="form-control" placeholder="Your Full Name"/>
                    ...
                    <div class="col-md-6">
                     ...
                     value={number}
                  onChange={(e) => setNumber(e.target.value)}
                type="text" class="form-control" placeholder="Your Phone" /></div>
                </div>
                ...
                <div class="row ">
                  ...
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  type="text" class="form-control" placeholder="Your Phone Email" />
                    </div>
                    <div class="col-md-12"><label class="labels">Address</label>
                    <select name="address" id="address" value={address} onChange={(e) => setAddress(e.target.value)} class="form-control">
    ...
    <option value="TPHCM">TPHCM</option>
                    ...
                    <input name="thumbnail" 
                  onChange={(e) => setThumbnail(e.target.files[0])}
                id="thumbnail" type="file" class="form-control" placeholder="Your Thumbnail"/></div>
                    <div class="col-md-12"><label class="labels">File Cv</label>
                    <input name="fileCv" id="fileCv" 
                  onChange={(e) => setFileCv(e.target.files[0])}
                type="file" class="form-control" placeholder="Your  CV" />
                    </div>
                  ...
                  type="text" class="form-control" placeholder="Your skills" />
                    ...
                    <div class="col-md-12"><label class="labels">WorkExperiences</label>
                    <select name="workExperiences" id="workExperiences" value={workExperiences} onChange={(e) => setWorkExperiences(e.target.value)} class="form-control">
    <option value="">Select an WorkExperiences</option>
    ...
    <option value="senior">Senior</option>
                    ...
                    <div class="col-md-12"><label class="labels">Link Contact</label>
                    <input name="reference" 
                value={reference}
                 onChange={(e) => setReference(e.target.value)}
                id="reference" type="text" class="form-control" placeholder="Link Contact" />
                </div>
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="col-md-12">
                  <label class="labels">UniversityOrCollege</label>
                <input type="text"  class="form-control" name="universityOrCollege"
                 value={universityOrCollege}
                onChange={(e) => setUniversityOrCollege(e.target.value)}
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">IssuedDate</label><input type="date" class="form-control"
                    name="issuedDate"
                    value={issuedDate}
                   onChange={(e) => setIssuedDate(e.target.value)}
                   id="issuedDate" placeholder="20/20/2000" /></div>
                    <div class="col-md-6"><label class="labels">ExpiryDate</label><input type="date" class="form-control" name="expiryDate"
                 value={expiryDate}
                 onChange={(e) => setExpiryDate(e.target.value)}
                 id="expiryDate" placeholder="5/9/2024"/></div>
                </div>
                ...
                <div class="col-md-12">
                  <label class="labels">Major</label>
                <input type="text"  class="form-control" 
               ame="scientificAchievements" 
               value={scientificAchievements}
                onChange={(e) => setScientificAchievements(e.target.value)}
               id="scientificAchievements"
                 placeholder="ScientificAchievements"/>
                </div>   
            </div>
        </div>
    </div>
