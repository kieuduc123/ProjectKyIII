...
const Contact = () => {
        ...
        <div>
            ...
            <div class="container rounded bg-white mt-5 mb-5">
                <div class="row border">
                    ...
                    <form  class="contact__form row"  enctype="multipart/form-data"  onSubmit={handleFormCv}>
    ...
    <div className="form-check">
        <input
            name="gender"
            id="gender"
            value="male" // Giá trị tương ứng với giới tính nam
            checked={gender === "male"} // Kiểm tra nếu gender là "male" thì đánh dấu checkbox
            onChange={(e) => setGender(e.target.value)}
            type="checkbox" // Sử dụng type là "checkbox"
    ...
    <div className="form-check">
        ...
        <label className="form-check-label">Female</label>
                                ...
                                <div class="col-md-12">
                                    <label class="labels">Thumbnail</label>
                                    <input
                                        name="Thumbnail"
                                        onChange={(e) =>
                                ...
                                <div class="col-md-12">
                                    <label class="labels">Link Contact</label>
                                    <input
                                        name="reference"
                                        value={reference}
                                        onChange={(e) =>
                    ...
                    <div class="col-md-6">
                        <div class=" py-5">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-6">
                                    <label class="labels">IssuedDate</label>
                                    <input
                                        type="date"
                                        class="form-control"
                                        name="issuedDate"
                                ...
                                <div class="col-md-6">
                                    <label class="labels">ExpiryDate</label>
                                    <input
                                        type="date"
                                        class="form-control"
                                        name="expiryDate"
                            ...
                            <div class="col-md-12">
                                <label class="labels">ScientificAchievements</label>
                                <input
                                                name="scientificAchievements"
                                                value={scientificAchievements}
                                                onChange={(e) =>
