    ...
    const handleFormCv = async (e) => {
        ...
        try {
            ...
            const font = {
                ...
                issuedDate: "2024-01-01T00:00:00",
                gender: "duc",
                expiryDate: "2024-01-05T00:00:00",
                dateOfBirth: "2017-08-09T00:00:00",
                age: 18,
                scientificAchievements: "gioi",
                workExperiences: "gioi",
                reference: "fb minh beo",
               
            };
            const res = await sendFormCv(font, {
                headers: {
                                ...
                                <div class=" py-5">
                                    ...
                                    <div class="col-md-12">
                                                ...
                                                >
                                                    ...
                                                    Research and Research on Drug Preparation
                                                    </option>
                                                    ...
                                                    Pharmaceutical Management & Economics
                                                    </option>
                                                    <option value="OTHER">
                                                       OTHER....
                                                    </option>
