...
const ProfileCv = () => {
    ...
    const handleFormCv = async (e) => {
        ...
        try {
            ...
            formData.append('idCandidate', idCandidate);
...
formData.append("universityOrCollege" , universityOrCollege);
formData.append("major" , major);
formData.append("issuedDate" , issuedDate);
formData.append("expiryDate" , expiryDate);
formData.append("scientificAchievements" , scientificAchievements);
formData.append("workExperiences" , workExperiences);
