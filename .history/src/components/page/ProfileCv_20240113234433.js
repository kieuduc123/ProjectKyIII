...
// từ từ anh bảo mở cho anh một cái note ra để anh copy đoaạn code naày vaào
  // quay laại note
  // note
    useEffect(() => {
    ...
    const addToFormData = (formData, data) => {
      ...
      const handleFormCv = async (e) => {
        ...
        try {
          ...
          // em thử submit roôồi mở sẵn network lên anh xem nào?
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="block text-center">
                                <span class="text-white">Create a Profile Cv</span>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="section-title text-center">
                                <h2 class="text-md mb-2">Create a Profile Cv</h2>
