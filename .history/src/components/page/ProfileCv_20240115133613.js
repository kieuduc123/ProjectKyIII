...
const ProfileCv = () => {
    ...
    const addToFormData = (formData, data) => {
      ...
      if(!accessToken){
        toast.warning("Account not Login")
       navigate("/login");
    ...
    return (
        <div>
            <section class="page-title bg-1">
                ...
                <img src="https://scontent.fhan14-3.fna.fbcdn.net/v/t39.30808-6/410940168_755266913311500_2471520829722583506_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=3635dc&_nc_ohc=S0cvMLm1nacAX8Q0IYP&_nc_ht=scontent.fhan14-3.fna&oh=00_AfBs9Y2Xgc7IjkdMbRup-lbML0yobTgkIq_z7sJZnWZm7Q&oe=65A97880"alt="" className=" w-100"/>
                <div class="container ">
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="p-3 py-5">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div className="form-check col-3 d-flex">
                                    ...
                                    <div class="mt-5 text-center">
                                        <button
                                            class="btn bg-primary profile-button text-white"
                                            type="submit"
                                        >
                                            Save Profile
                                        </button>
