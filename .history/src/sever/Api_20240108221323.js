...
const baseUrl = "https://pharmacyonline.azurewebsites.net/api";
...
instance.interceptors.response.use(
  ...
  async function (error) {
    ...
    if (
      ...
      error.config.url === "https://pharmacyonline.azurewebsites.net/api/Authentication/candidate/refreshtoken"
    ) {
