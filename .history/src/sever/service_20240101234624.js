...
export const logOut = async (id) => {
  const res = await axios.post(
   "https://pharmacyonline.azurewebsites.net/api/Authentication,Authentication/candidate/logout",
   {...id}
  );
  return res;
};
export const callRegisterUser = async (user) => {
  const res = await axios.post(
    "https://pharmacyonline.azurewebsites.net/api/Authentication/Authentication/candidate/register",
    { ...user }
  );
  return res;
};
