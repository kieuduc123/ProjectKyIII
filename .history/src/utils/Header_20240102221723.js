		...
		<div class="container">
			...
			{user ? (
                  ...
                  <div class="dropdown  btn btn-main-2 btn-round-full btn-icon">
					 <li class="tooltip"><i class="fa fa-bars" aria-hidden="true"></i>&nbsp;&nbsp;Bottom Menu</li>
            <div class="tooltipMenu bottomSide">
              <ul>
                <li>Link 1 <i class="fa fa-free-code-camp fr" aria-hidden="true"></i></li>
                <li>Link 2 <i class="fa fa-user-o fr" aria-hidden="true"></i></li>
                <li>Link 3 <i class="fa fa-bluetooth fr" aria-hidden="true"></i></li>
                <li>Link 4 <i class="fa fa-cubes fr" aria-hidden="true"></i></li>
                <li>Link 5 <i class="fa fa-futbol-o fr" aria-hidden="true"></i></li>
                <li>Link 6 <i class="fa fa-folder-open fr" aria-hidden="true"></i></li>
              </ul>
            </div>
