			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						<h2 class="heading-section mb-5 pb-md-4">Dropdown #02</h2>
					</div>
				</div>
				<div class="row justify-content-center">
					...
					<div class="col-md-6 d-flex justify-content-center">
						<div class="btn-group">
						  <a href="#" class="btn-img img dropdown-toggle rounded-circle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style={{backgroundImage: "url(https://img.vn/uploads/thuvien/singa-png-20220719150401Tdj1WAJFQr.png)"}}>
						  </a>
