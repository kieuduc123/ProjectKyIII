            ...
            <div className="the-news">
                <div className="row">
                    ...
                    <div className="col-12 col-md-6">
                        <div className="the-news-wrap">
                            <figure className="post-thumbnail">
                                <NavLink toto="#"><img src="https://www.digitalvidya.com/blog/wp-content/uploads/2016/12/Digital_marketng_expert.jpg" alt=""/></NavLink>
                            </figure>

                            <header className="entry-header">
                                <h3>Online marketing expert</h3>
                    ...
                    <div className="col-12 col-md-6">
                        <div className="the-news-wrap">
                            ...
                            <header className="entry-header">
                                <h3>Recruitment for rehabilitation</h3>
